...
public:
    ...
    // 3 - way paritioning: To protect against arrays with too many duplicate elements.
    // The range [lt, gt] consists entirely of elements equal to pivot, so no need to sort
    // that segment any more.
